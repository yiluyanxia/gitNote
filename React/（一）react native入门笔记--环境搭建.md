...
```
![image](https://upload-images.jianshu.io/upload_images/10898004-150c80c23c6c177e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
```
然后bug就来了，出现红色的提示  
![cmd运行报错](https://note.youdao.com/favicon.ico)
...
![Android Studio运行报错](https://note.youdao.com/favicon.ico)
...
```
![连接夜神](https://note.youdao.com/favicon.ico)
...
```
 react-native run-android
```
![运行项目](https://note.youdao.com/favicon.ico)
...
6. 关闭模拟器重新执行以上步骤
噔噔噔噔！  
![完成了](https://note.youdao.com/favicon.ico)  
终于出来了！  
